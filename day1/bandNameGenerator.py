...
print("\nMein erster Vorschlag für deinen Bandnamen ist " + users_first_band_name_suggestion)
print("\nMein zweiter Vorschlag für deinen Bandnamen ist " + users_second_band_name_suggestion)